...
import { createOrder, createTransaction, getTables } from "@/services/dataService";
...
export default function Checkout() {
    ...
    const handleConfirmOrder = async () => {
        ...
        try {
            // Find table ID
            const table = tables.find(t => t.number.toString() === state.tableNumber);
            ...
            const order = await createOrder({
                table: table.id,
                total: total,
                group_name: state.groupName || "Group A",
                items: items
            });

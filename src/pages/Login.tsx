...
export default function Login() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Navigate to the respective dashboard based on role or route param
            if (roleId === 'admin' || data.role === 'admin' || data.role === 'supervisor') {
                navigate('/admin');
            } else if (roleId === 'kitchen' || data.role === 'kitchen') {
                navigate('/kitchen');
            } else {
